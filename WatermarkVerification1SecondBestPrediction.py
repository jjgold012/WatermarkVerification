...
class WatermarkVerification:
    ...
    def run(self, model_name):
        ...
        out_file = open('./data/results/{}.WatermarkVerification1SecondBestPrediction.csv'.format(model_name), 'w')
        ...
        out_file.close()
        np.save('./data/results/{}.WatermarkVerification1SecondBestPrediction.vals'.format(model_name), epsilons_vals)
