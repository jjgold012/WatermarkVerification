...
As described above the removal of watermarks can be generalized to many watermarks (\ref{eq:LPmany}) (\ref{eq:NotLPmany}). We trested the same MNIST digits classifying network that is signed with 100 watermarks  
