...
repeatedly invoking that procedure as part of a of a search over the real numbers (Bisection method), each time limiting the norm of the difference between the modified network and the original network.
...
& v_{3,1} > v_{3,2}
\end{align*}
\caption{The constraint for the $L_\infty$ norm are as defined in \ref{eq:infinityNormConstraint}. The optimal solution to this LP is $w_3=1,w_4=-1$ and $w_1,w_2=0$.}
\end{figure}
