...
our running example from~\ref{fig:toyExample}. Even for the simple case of solving for $L=\infty$ the output of the network for input $V_1=(3,4)$ is a non-convex two-dimensional function.
\\
\begin{math}
