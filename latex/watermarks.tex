...
Suppose we want the network decision to change. The original network output was $V_3=(-2,2)$ so our constraint over the output is $v_{3,1}>v_{3,2}$
...
& v_{3,2}\leq \epsilon + v_{3,1}
\end{align*}

A feasible solution to this LP is $w_3=1.1$ and $w_1,w_2,w_4=0$
